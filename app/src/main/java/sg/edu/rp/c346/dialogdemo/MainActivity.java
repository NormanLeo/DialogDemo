...
*/
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText etEnter1 = viewDialog.findViewById(R.id.editTextEnter1);
                final EditText etEnter2 = viewDialog.findViewById(R.id.editTextEnter2);
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String no1 = etEnter1.getText().toString();
                        String no2 = etEnter2.getText().toString();
                        tvExercise3.setText("The sum is " + (no1+no2));
                    }
                });
                myBuilder.setNegativeButton("Cancel", null);
                AlertDialog myDialog = myBuilder.create();
